                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        ...
                        (_appStore.isUserAuthenticated &&
                            _appStore.user!.email ==
                                _homeStore.posts.where((element) => element.slug == post.slug).first.author!.email)
                            ? Container(
                                    ...
                                    var resultUpdate = await Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (_) =>
                                                UpdatePostView(
                                                    post:
                                                    _homeStore.posts.where((element) => element.slug == post.slug).first)));
                    ...
                    ClipRRect(
                      ...
                      child: Image.network(
                        _homeStore.posts.where((element) => element.slug == post.slug).first.image!,
                        height:
                    ...
                    Align(
                      ...
                      child: Text(
                        _homeStore.posts.where((element) => element.slug == post.slug).first.title,
                        maxLines: 3,
                    ...
                    Text(
                      _homeStore.posts.where((element) => element.slug == post.slug).first.body,
